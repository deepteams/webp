...
|---------|------|-----:|-----:|------:|-------:|
| **deepteams/webp** (Pure Go) | Lossy | **49.2 ms** | 3.9 | 1.0 MB | 172 |
| gen2brain/webp (WASM) | Lossy | 57.6 ms | 4.4 | 13 KB | 12 |
| chai2010/webp (CGo) | Lossy | 76.0 ms | 2.8 | 227 KB | 4 |
| **deepteams/webp** (Pure Go) | Lossless | **125.3 ms** | 14.6 | 17.7 MB | 223 |
| gen2brain/webp (WASM) | Lossless | 186.3 ms | 11.0 | 343 KB | 12 |
| nativewebp (Pure Go) | Lossless | 279.9 ms | 7.2 | 89.3 MB | 2,155 |
| chai2010/webp (CGo) | Lossless | 970.0 ms | 1.8 | 2.6 MB | 4 |

### Decode (1536x1024)

| Library | Mode | Time | MB/s | B/op | Allocs |
|---------|------|-----:|-----:|------:|-------:|
| chai2010/webp (CGo) | Lossy | **9.2 ms** | 22.6 | 6.8 MB | 23 |
| **deepteams/webp** (Pure Go) | Lossy | **9.6 ms** | 20.1 | 2.6 MB | 7 |
| golang.org/x/image/webp | Lossy | 18.6 ms | 10.4 | 2.6 MB | 13 |
| gen2brain/webp (WASM) | Lossy | 22.0 ms | 11.5 | 622 KB | 40 |
| chai2010/webp (CGo) | Lossless | **19.2 ms** | 91.2 | 10.6 MB | 30 |
| **deepteams/webp** (Pure Go) | Lossless | **28.5 ms** | 64.4 | 8.3 MB | 289 |
| gen2brain/webp (WASM) | Lossless | 34.9 ms | 58.9 | 4.7 MB | 46 |
| nativewebp (Pure Go) | Lossless | 36.6 ms | 55.0 | 6.4 MB | 50 |
| golang.org/x/image/webp | Lossless | 39.4 ms | 46.5 | 7.3 MB | 1,126 |
